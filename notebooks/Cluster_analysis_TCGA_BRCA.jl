...
We will load the data from JuliaHub. First we need to authenticate:
"

# ╔═╡ bf7b2ec7-9b4d-4075-8605-06bd2fe57a88
JuliaHub.authenticate("https://juliahub.com");

# ╔═╡ b0691a12-ab11-4cd5-b233-a458d6d2800e
md"We can now access the data using the `dataset` function:"

# ╔═╡ 17a35e1c-c037-44c9-92a4-d9c57608cb74
ds = JuliaHub.dataset(("tmichoel-1", "TCGA_BRCA"))

# ╔═╡ a8eb69cb-a15e-4c21-9c2c-5337303d3b98
ds.description
...
manifest_format = "2.0"
project_hash = "aa391b5a559756cd5d470328d5e5d9983d2e65fa"
...
git-tree-sha1 = "f9cf11f1a6c1b8399d20a3ed16db3680e55a6460"
...
git-tree-sha1 = "157b5665879d73b5473dc019a7e2bd4d22c484bf"
...
[[deps.Rclone_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "aa80dbc8acee8402de7c32241fb2acc8a392d8b6"

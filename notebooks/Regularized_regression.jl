...
mach_opt = machine(std_elnet_model_opt, X_sub, y);
...
X_sub_filt = DataFrames.select(X_sub, nms_filt)# X_sub[:,df_coefs.abs_value .> 0.0]
...
mm=Matrix(X_sub_filt_std[spy,:])'

# ╔═╡ b5df8a6a-c638-46b7-95ab-21dccf27091b
begin
	phm = heatmap(mm, c=:balance)
